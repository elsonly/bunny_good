...
drop function if exists dealer.ft_get_positions_fifo_concat;

CREATE or replace function dealer.ft_get_positions_fifo_concat(
	in_date date,
...
/*
	select * from dealer.ft_get_positions_fifo_concat(CURRENT_DATE, 'B');
*/
