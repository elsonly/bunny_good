...
@task(name="task-institute_fund-save2db", log_prints=True)
...
@task(name="task-institute_fund-get_last_date", log_prints=True)
...
@task(name="task-institute_fund-get_trading_dates", log_prints=True)
